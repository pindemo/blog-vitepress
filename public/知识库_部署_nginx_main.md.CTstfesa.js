import{_ as p,C as e,c as i,o as t,j as s,G as l,a5 as c,a as o}from"./chunks/framework.DRLXfOPz.js";const f=JSON.parse('{"title":"nginx","description":"","frontmatter":{},"headers":[],"relativePath":"知识库/部署/nginx/main.md","filePath":"知识库/部署/nginx/main.md","lastUpdated":1738741170000}'),r={name:"知识库/部署/nginx/main.md"};function d(h,n,m,g,_,x){const a=e("ArticleMetadata");return t(),i("div",null,[n[0]||(n[0]=s("h1",{id:"nginx",tabindex:"-1"},[o("nginx "),s("a",{class:"header-anchor",href:"#nginx","aria-label":'Permalink to "nginx"'},"​")],-1)),l(a),n[1]||(n[1]=c(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>启动</span></span>
...
<span class="line"><span>        }</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,3))])}const v=p(r,[["render",d]]);export{f as __pageData,v as default};
