import{_ as e,C as n,c as p,o as r,j as s,G as h,a as i,w as a}from"./chunks/framework.DRLXfOPz.js";const o=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"知识库/shell/tips/2-目录查看.md","filePath":"知识库/shell/tips/2-目录查看.md","lastUpdated":1738741170000}'),d={name:"知识库/shell/tips/2-目录查看.md"};function g(y,l,F,c,D,A){const k=n("Card"),t=n("Collapse");return r(),p("div",null,[l[3]||(l[3]=s("h3",{id:"目录查看-ls",tabindex:"-1"},[i("目录查看 ls "),s("a",{class:"header-anchor",href:"#目录查看-ls","aria-label":'Permalink to "目录查看 ls"'},"​")],-1)),l[4]||(l[4]=s("hr",null,null,-1)),h(k,null,{title:a(()=>l[0]||(l[0]=[i(" 实例 ")])),default:a(()=>[l[1]||(l[1]=s("div",{class:"language-sh vp-adaptive-theme"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"sh"),s("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#6F42C1","--shiki-dark":"#B392F0"}},"ls"),s("span",{style:{"--shiki-light":"#6A737D","--shiki-dark":"#6A737D"}},"       # 仅列出当前目录可见文件")]),i(`
