import{_ as i,c as a,o as n,a5 as l}from"./chunks/framework.DRLXfOPz.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"知识库/rust/child/0-安装与命令.md","filePath":"知识库/rust/child/0-安装与命令.md","lastUpdated":1738741170000}'),p={name:"知识库/rust/child/0-安装与命令.md"};function t(h,s,e,k,r,d){return n(),a("div",null,s[0]||(s[0]=[l(`<h2 id="安装与命令" tabindex="-1">安装与命令 <a class="header-anchor" href="#安装与命令" aria-label="Permalink to &quot;安装与命令&quot;">​</a></h2><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 安装</span></span>
