import{_ as p,c as e,j as s,a as i,G as t,a5 as l,B as c,o}from"./chunks/framework.DoSVD-D7.js";const v=JSON.parse('{"title":"nginx","description":"","frontmatter":{},"headers":[],"relativePath":"知识库/部署/nginx/main.md","filePath":"知识库/部署/nginx/main.md","lastUpdated":1728899331000}'),r={name:"知识库/部署/nginx/main.md"};function d(h,n,m,g,x,u){const a=c("ArticleMetadata");return o(),e("div",null,[n[0]||(n[0]=s("h1",{id:"nginx",tabindex:"-1"},[i("nginx "),s("a",{class:"header-anchor",href:"#nginx","aria-label":'Permalink to "nginx"'},"​")],-1)),t(a),n[1]||(n[1]=l(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>启动</span></span>
