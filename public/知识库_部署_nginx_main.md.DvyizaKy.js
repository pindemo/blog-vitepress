import{_ as p,c as e,j as s,a as i,G as l,a4 as t,o as c,B as o}from"./chunks/framework.bh9iDcjP.js";const v=JSON.parse('{"title":"nginx","description":"","frontmatter":{},"headers":[],"relativePath":"知识库/部署/nginx/main.md","filePath":"知识库/部署/nginx/main.md","lastUpdated":1726216260000}'),r={name:"知识库/部署/nginx/main.md"};function d(h,n,m,g,x,u){const a=o("ArticleMetadata");return c(),e("div",null,[n[0]||(n[0]=s("h1",{id:"nginx",tabindex:"-1"},[i("nginx "),s("a",{class:"header-anchor",href:"#nginx","aria-label":'Permalink to "nginx"'},"​")],-1)),l(a),n[1]||(n[1]=t(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>启动</span></span>
<span class="line"><span>start nginx</span></span>
<span class="line"><span></span></span>
<span class="line"><span>重启</span></span>
<span class="line"><span>nginx -s reload</span></span></code></pre></div><h2 id="配置-nginx-conf" tabindex="-1">配置 nginx.conf <a class="header-anchor" href="#配置-nginx-conf" aria-label="Permalink to &quot;配置 nginx.conf&quot;">​</a></h2><div class="language-conf vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">conf</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span></span></span>
